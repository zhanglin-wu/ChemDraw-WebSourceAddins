...
Launch ChemDraw Office, and go to **Add-ins > Add-in Manager... > Add > Add from URL...**, and enter a URL that directs to an add-in manifest listed in [manifest examples](./Manifests).
...
- Manifest 1. A manifest that is an empty string
  - `xxxx`
- Manifest 2. xxxx
